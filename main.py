...
data = {"words":{"value":words,"color":get_random_color()},"city":{"value":city},"rightNow":{"value":get_now(),"color":get_random_color()},"weather":{"value":wea,"color":get_random_color()},"temperature":{"value":temperature,"color":get_random_color()},"highest": {"value":highest,"color":get_random_color()},"lowest":{"value":lowest, "color":get_random_color()}}
count = 0
